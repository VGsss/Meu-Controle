        ...
        switch (requestCode) {
            case REQUEST_CODE_OPENER:
                if (resultCode == RESULT_OK) {
                    ...
                    Intent myIntent = new Intent(PickFileWithOpenerActivity.this, EditorTXT.class);
                    myIntent.putExtra("IDArquivo", driveId.getResourceId());
                    PickFileWithOpenerActivity.this.startActivity(myIntent);
                }
                finish();
                break;
            default:
